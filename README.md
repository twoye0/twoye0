...
- 🏫 Financial Mathematics Major (금융수학 전공)
- 🏆 GPA: **4.45 / 4.5**
...
🇬🇧 Short-term language program at **University of Sheffield (UK)**  
...
I enjoy exploring how **mathematics and data can explain financial markets**.
...
I aim to understand financial markets through **mathematics, data, and systematic reasoning**,  
and develop **rigorous quantitative trading strategies**.

수학과 데이터를 기반으로 금융 시장을 이해하고,  
**정량적 분석에 기반한 체계적인 투자 전략**을 개발하는 것을 목표로 합니다.
